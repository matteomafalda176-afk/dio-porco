...
const Portfolio: React.FC = () => {
  ...
  return (
    <section id="portfolio" className="py-6 sm:py-12 lg:py-14 bg-brand-black grain">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {videoFrames.map((frame, index) => (
            <div
              ...
              className={`
                ...
                bg-brand-gray/10 border-2 border-brand-gray/30 rounded-2xl sm:rounded-3xl p-3 sm:p-6 hover:shadow-2xl hover:border-brand-orange hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 animate-slide-up group grain overflow-hidden
              `}
            ...
            >
              <div
                className={`
                  ...
                  bg-brand-black rounded-2xl relative overflow-hidden cursor-pointer border-2 border-brand-gray/30 group-hover:border-brand-orange/50 transition-all duration-300
                `}
              >
                <div className="absolute inset-0 bg-gradient-to-br from-brand-black/70 via-brand-black/60 to-brand-black/70 group-hover:from-brand-black/50 group-hover:via-brand-black/40 group-hover:to-brand-black/50 transition-all duration-500"></div>
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center transform group-hover:scale-105 transition-transform duration-300">
                    ...
                    <p className="text-brand-white/60 text-[10px] sm:text-xs mt-1">Guarda il video</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-6 sm:mt-10 lg:mt-12 text-center px-3">
          <button className="bg-brand-orange hover:bg-brand-orange/90 active:scale-95 text-brand-white px-6 sm:px-12 py-4 sm:py-5 rounded-xl sm:rounded-2xl font-bold transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:shadow-brand-orange/30 grain text-sm sm:text-base w-full sm:w-auto min-h-[48px]">
